...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.settings: dict[str, Any] = orjson.loads(pathlib.Path("../data/settings.json").read_text(encoding="utf-8"))
    ...
    def saveSettings(self):
        ...
        pathlib.Path("../data/settings.json").write_text(json.dumps(file_settings, indent=4, ensure_ascii=False), encoding="utf-8")
