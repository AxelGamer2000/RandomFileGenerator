...
################################################################################
## Form generated from reading UI file 'rfgJoQMVf.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fileContentCheckBox.setGeometry(QRect(410, 40, 111, 23))
        self.fileSizeCheckBox = QCheckBox(self.centralwidget)
        self.fileSizeCheckBox.setObjectName(u"fileSizeCheckBox")
        self.fileSizeCheckBox.setGeometry(QRect(410, 60, 91, 23))
        self.label_4 = QLabel(self.centralwidget)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(440, 120, 66, 18))
        self.scriptComboBox = QComboBox(self.centralwidget)
        self.scriptComboBox.setObjectName(u"scriptComboBox")
        self.scriptComboBox.setGeometry(QRect(440, 140, 131, 26))
        self.runButton = QPushButton(self.centralwidget)
        self.runButton.setObjectName(u"runButton")
        self.runButton.setGeometry(QRect(440, 170, 131, 26))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Script", None))
